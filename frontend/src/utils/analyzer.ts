...
export const TOKEN_METADATA: Record<string, {
  ...
  'dog-bitcoin': { team: 0, investors: 0, community: 100, treasury: 0, stakingAvailable: false, governancePower: false, feeBurning: false, neededToUse: false, vestingYears: 0, treasuryUSD: 0, note: 'Memecoin — DOG•GO•TO•THE•MOON (Rune #3). Bitcoin Runes protocol lançado no halving 2024. Supply fixo de 100B. Distribuição 100% via airdrop/mint para a comunidade Bitcoin.', teamTransparency: 'anonymous', teamNote: 'Time anônimo. Runes é um protocolo descentralizado na rede Bitcoin — sem empresa ou fundação central.' },
...
export function analyzeToken(token: TokenData): AnalysisResult {
  ...
  const isMemeToken = (
    ...
    ['dogecoin', 'shiba-inu', 'pepe', 'dog-bitcoin', 'dogwifcoin', 'bonk', 'floki',
