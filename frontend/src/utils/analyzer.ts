...
export const DATA_LAST_UPDATED = '2026-06-18';
...
export const TOKEN_METADATA: Record<string, {
  ...
  'bianrensheng': { launchYear: 2025, innovationLevel: 'clone', team: 0, investors: 0, community: 100, treasury: 0, stakingAvailable: false, governancePower: false, feeBurning: false, neededToUse: false, vestingYears: 0, treasuryUSD: 0, teamTransparency: 'anonymous', note: '币安人生 (Binance Life) — memecoin cultural na BNB Chain. Nasceu de interação viral envolvendo co-fundador da Binance. Narrativa sobre "vida no ecossistema cripto". Popularidade concentrada em comunidades asiáticas. ⚠️ Memecoin puro sem utilidade. Time anônimo. Liquidez e volume podem ser voláteis.', teamNote: 'Time anônimo. Projeto comunitário sem fundadores identificados.' },
  // ── The Open Network ──────────────────────────────────────────────────────
  ...
  'lab': { launchYear: 2025, innovationLevel: 'incremental', team: 20, investors: 15, community: 60, treasury: 5, stakingAvailable: true, governancePower: false, feeBurning: false, neededToUse: true, vestingYears: 2, treasuryUSD: 30000000, note: 'LAB — All-in-one trading ecosystem na BNB Chain. Execução rápida, fees baixos, incentive layer viral. 1B supply fixo, ~403M circulando. Integrado a plataformas de trading existentes. Categorias DeFi, Analytics, Launchpad. Binance Alpha listado.', teamTransparency: 'low' },
  'dexe': { launchYear: 2020, innovationLevel: 'incremental', team: 20, investors: 2, community: 25, treasury: 53, stakingAvailable: true, governancePower: true, feeBurning: false, neededToUse: false, vestingYears: 2, treasuryUSD: 50000000, teamTransparency: 'medium', note: 'DEXE — protocolo de social trading e toolkit para criação de DAOs descentralizados. Foundation 53.5% (treasury + ecosystem + liquidity), Community 25% (staking + tournaments), Team 20%, Public 1.5%. 100M supply total. Team vesting completamente desbloqueado (abril 2023). Wallet-to-wallet copy trading sem expor chaves privadas. AI agents em governança em desenvolvimento. ⚠️ Foundation controla 53.5% do supply — alta concentração. Equipe reduziu headcount recentemente.', teamNote: 'Dmytro Kotliarov e Serhii Krauch são co-fundadores públicos. Operação via Swiss Association. Time com background verificável mas headcount em declínio.' },
  ...
  // ── Enterprise L1 ─────────────────────────────────────────────────────────
  'xdce-crowd-sale': { launchYear: 2019, innovationLevel: 'incremental', team: 40, investors: 0, community: 27, treasury: 27, stakingAvailable: true, governancePower: true, feeBurning: false, neededToUse: true, vestingYears: 3, treasuryUSD: 100000000, teamTransparency: 'medium', centralizedControl: true, controlledPct: 67, note: 'XDC — L1 enterprise focada em trade finance e tokenização de RWA. XDPoS consensus (Delegated PoS). 38B total supply, ~16-20B circulando. Masternodes requerem 10M XDC stake. Team/founders 40% com unlock de 3%/ano. ⚠️ ALTA CENTRALIZAÇÃO: founders+ecosystem controlam ~67% do supply. Modelo enterprise permissionado não é DeFi-nativo. Supply inflacionário (uncapped). Adoção real modesta apesar de parcerias anunciadas.', teamNote: 'Atul Khekade e Ritesh Kakkad são co-fundadores públicos. XinFin (empresa original) tem equipe verificável. Rebranding para XDC Network em 2019.' },
  ...
  'venice-token': { launchYear: 2025, innovationLevel: 'major', team: 20, investors: 0, community: 50, treasury: 30, stakingAvailable: true, governancePower: false, feeBurning: true, verifiedFeeBurn: true, neededToUse: true, vestingYears: 2, treasuryUSD: 100000000, teamTransparency: 'high', note: 'VVV — token de capital da Venice AI, plataforma líder de AI privada e sem censura com 2M+ usuários. ERC20 na Base chain. 100M supply gênese. 50% airdropped para comunidade. Buy-and-burn mensal com receita da plataforma. Staking gera yield + acesso Venice Pro (100 VVV mínimo). DIEM: segundo token mintável apenas por stakers. ⚠️ Modelo depende de crescimento contínuo de receita da plataforma AI para sustentar burns. Concorrência crescente: AI descentralizada é um campo lotado.', teamNote: 'Erik Voorhees (fundador ShapeShift) é o fundador da Venice AI. Público e com histórico extenso no ecossistema cripto desde 2011.' },
  ...
  'janus-henderson-anemoy-aaa-clo-fund': { team: 0, investors: 0, community: 0, treasury: 100, stakingAvailable: false, governancePower: false, feeBurning: false, neededToUse: false, vestingYears: 0, treasuryUSD: 0, teamTransparency: 'high', note: 'JAAA — fundo tokenizado de CLOs (Collateralized Loan Obligations) AAA-rated da Janus Henderson via Anemoy/Centrifuge. Produto institucional regulado — não é cripto especulativo. Yield de dívida corporativa AAA tokenizada on-chain.', teamNote: 'Janus Henderson ($350B+ AUM) é gestora global regulada. Anemoy e Centrifuge são parceiros de tokenização.' },
  'spiko-amundi-overnight-swap-fund-eur': { team: 0, investors: 0, community: 0, treasury: 100, stakingAvailable: false, governancePower: false, feeBurning: false, neededToUse: false, vestingYears: 0, treasuryUSD: 0, teamTransparency: 'high', note: 'EURSAFO — fundo de money market overnight em EUR tokenizado pela Spiko em parceria com Amundi (maior gestora europeia). Produto institucional — rendimento overnight de swaps EUR. Não é cripto especulativo.', teamNote: 'Amundi (€2T+ AUM) é a maior gestora de ativos da Europa. Spiko é o parceiro de tokenização on-chain.' },
